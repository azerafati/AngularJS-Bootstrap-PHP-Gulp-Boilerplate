app.factory('toast', ['$timeout', '$rootScope', function ($timeout, $rootScope) {
    ...
    var show = function (msg,alertType) {
        ...
        var tpl = '<div class="toast alert '+ alertType+' alert-dismissible fade" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>';
